...
const WeatherChart: React.FC<WeatherChartProps> = ({ hourlyData, dailyData, units }) => {
  ...
  const legendPayload = [
    { value: `Temp (${tempUnit})`, type: 'line', id: 'temperature', color: '#3b82f6' },
    { value: 'Feels Like', type: 'line', id: 'feelsLike', color: '#f97316' },
    { value: `Hist. Avg`, type: 'line', id: 'historicalAvgTemp', color: '#8b5cf6' },
    { value: 'Precip %', type: 'rect', id: 'precipitation', color: '#38bdf8' },
    { value: 'Humidity %', type: 'line', id: 'humidity', color: '#14b8a6' },
    { value: `Wind (${speedUnit})`, type: 'line', id: 'windSpeed', color: '#ec4899' },
    { value: 'UV Index', type: 'line', id: 'uvIndex', color: '#facc15' },
    { value: `Pressure (${pressureUnit})`, type: 'line', id: 'pressure', color: '#6b7280'},
    { value: `Visibility (${distanceUnit})`, type: 'line', id: 'visibility', color: '#10b981'},
    { value: `Dew Point (${tempUnit})`, type: 'line', id: 'dewPoint', color: '#0ea5e9'},
    { value: 'Cloud Cover %', type: 'line', id: 'cloudCover', color: '#a855f7'},
    { value: 'AQI', type: 'line', id: 'aqi', color: '#ef4444' },
    { value: 'Pollen', type: 'line', id: 'pollen', color: '#84cc16' },
  ].map(item => ({...item, inactive: !visibility[item.id as keyof VisibilityState]}));
